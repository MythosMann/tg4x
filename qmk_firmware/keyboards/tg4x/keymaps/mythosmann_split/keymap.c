...
//|---------'--,----'--,----'--,----'--,----'--,----'--,----'--,----'--,----'--,----'-----,-'-------------|
    KC_LSFT    , KC_Z  , KC_X  , KC_C  , KC_V  , KC_B  , KC_N  , KC_M  ,KC_COMM, KC_DOT,KC_SLSH, MO(_FL)  , \
//|---------,--'------,'-------',------'-------'-------',------'-------',------'--,----'--,----'--,-------|
     KC_LCTL, KC_LGUI , KC_LALT ,   LT(_FL,KC_SPC)      ,  KC_SPC       , KC_RALT ,KC_RGUI,MO(_OL),KC_RCTL   \
//`---------'---------'---------'-----------------------'---------------'---------'-------'-------'-------'
),
// ,-------.-------.-------.-------.-------.-------.-------.-------.-------.-------.-------.-------.-------.
// |  Esc  |   q   |   w   |   e   |   r   |   t   |   y   |   u   |   i   |   o   |   p   |   '   | Bspc  |
...
//|-------'-,-----'-,-----'-,-----'-,-----'-,-----'-,-----'-,-----'-,-----'-,-----'-,-----'-,-------------|
   KC_TRNS  ,KC_HOME,KC_PGUP,KC_TRNS,KC_TRNS,KC_TRNS,KC_MINS,KC_LBRC,KC_RBRC,KC_EQL ,KC_SCLN,    KC_ENT   , \
//|---------'--,----'--,----'--,----'--,----'--,----'--,----'--,----'--,----'--,----'--,----'--,----------|
